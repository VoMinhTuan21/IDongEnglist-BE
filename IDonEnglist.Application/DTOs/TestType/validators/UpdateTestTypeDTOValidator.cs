...
{
    public class UpdateTestTypeDTOValidator : AbstractValidator<UpdateTestTypeDTO>
    {
        public UpdateTestTypeDTOValidator()
        {
            ...
            RuleForEach(p => p.Parts).SetValidator(new UpdateTestPartDTOValidator());
